...
public class LineChartView extends View
{
    ...
    private String startTime = "2017-05-01";
    private String endTime = "2017-06-01";
    ...
    public int getmMargin10()
    {
        return mMargin10;
    }

    public void setmMargin10(int mMargin10)
    {
        this.mMargin10 = mMargin10;
    }
    ...
    public void setItems(List<ItemBean> mItems)
    {
        this.mItems = mItems;
    }
    ...
    public void setAxesWidth(float mAxesWidth)
    {
        this.mAxesWidth = mAxesWidth;
    }
    ...
    public LineChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        ...
        mAxesColor = typedArray.getColor(R.styleable.LineChartView_axesColor, Color.parseColor
                ("#CCCCCC"));
        mAxesWidth = typedArray.getDimension(R.styleable.LineChartView_axesWidth, 1);
        mTextColor = typedArray.getColor(R.styleable.LineChartView_textColor, Color.parseColor
                ("#ABABAB"));
        ...
        mMargin10 = DensityUtils.dip2px(context, 10);
        init();
    }
    ...
    private void drawLine(Canvas canvas)
    {
        ...
        for (int i = 0; i < mItems.size(); i++)
        {
            ...
            {
                mPath.lineTo(x - mMargin10 - mAxesWidth, yOrigin - (mItems.get(i).getValue() -
                        min) / yInterval);
                mPathShader.lineTo(x - mMargin10 - mAxesWidth, yOrigin - (mItems.get(i).getValue
                        () - min) / yInterval);
                if (i == mItems.size() - 1)
                {
        ...
        //  渐变阴影
        Shader mShader = new LinearGradient(0, 0, 0, getHeight(), shadeColors, null, Shader
                .TileMode.CLAMP);
    ...
    //  折线数据的实体类
    public static class ItemBean extends YHModel
    {
