...
public class YHWebView
{
    ...
    private YHWebView mAgentWeb = null;
    ...
    private YHWebView(AgentBuilder agentBuilder) {
    ...
    private YHWebView(AgentBuilderFragment agentBuilderFragment) {
    ...
    public YHWebView clearWebCache() {
    ...
    /*public static YHWebView withCreatorWeb(WebCreator creatorWeb) {
    ...
    private YHWebView go(String url) {
...
//
      ...
      /*  *//*如果index==-1 默认为最后*//*
        ...
        private PreAgentWeb buildAgentWeb() {
            return new PreAgentWeb(HookManager.hookAgentWeb(new YHWebView(this), this));
        }
    ...
    public static class PreAgentWeb {
        ...
        PreAgentWeb(YHWebView agentWeb) {
        ...
        public YHWebView go(@Nullable String url) {
            if (!isReady) {
