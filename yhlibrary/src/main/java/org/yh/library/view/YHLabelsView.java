 ...
 *
 */
public class YHLabelsView extends ViewGroup implements View.OnClickListener {
    ...
    public YHLabelsView(Context context) {
        super(context);
        mContext = context;
    }

    public YHLabelsView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        getAttrs(context, attrs);
    }

    public YHLabelsView(Context context, AttributeSet attrs, int defStyleAttr) {
