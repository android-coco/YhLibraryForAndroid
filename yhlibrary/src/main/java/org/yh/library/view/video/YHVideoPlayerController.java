...
import static org.yh.library.R.id.error;
        ...
        SeekBar.OnSeekBarChangeListener
{
    ...
    private I_YHVideoPlayerControl mNiceVideoPlayer;
    ...
    public YHVideoPlayerController(Context context)
    {
        super(context);
        mContext = context;
        init();
    ...
    private void init()
    {
        ...
        mError = (LinearLayout) findViewById(error);
        ...
        if (!StringUtils.isEmpty(imageUrl))
        {
            if (imageUrl.endsWith(".gif"))
            {
                Glide.with(mContext)
                        ...
                        .error(R.drawable.icon_loding_error)
                        .crossFade()
                        .into(mImage);
            }else
            {
    ...
    public void setNiceVideoPlayer(I_YHVideoPlayerControl niceVideoPlayer)
    {
    ...
    public void setControllerState(int playerState, int playState)
    {
        switch (playerState)
        {
            case YHVideoPlayer.PLAYER_NORMAL:
                mBack.setVisibility(View.GONE);
                mFullScreen.setVisibility(View.VISIBLE);
                mFullScreen.setImageResource(R.drawable.ic_player_enlarge);
                break;
            case YHVideoPlayer.PLAYER_FULL_SCREEN:
                mBack.setVisibility(View.VISIBLE);
                mFullScreen.setVisibility(View.VISIBLE);
                mFullScreen.setImageResource(R.drawable.ic_player_shrink);
                break;
            case YHVideoPlayer.PLAYER_TINY_WINDOW:
                mFullScreen.setVisibility(View.GONE);
                break;
        }
        switch (playState)
        {
            case YHVideoPlayer.STATE_IDLE:
                break;
            case YHVideoPlayer.STATE_PREPARING:
                // 只显示准备中动画，其他不显示
                ...
                break;
            case YHVideoPlayer.STATE_PREPARED:
                startUpdateProgressTimer();
                break;
            case YHVideoPlayer.STATE_PLAYING:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(R.drawable.ic_player_pause);
                startDismissTopBottomTimer();
                break;
            case YHVideoPlayer.STATE_PAUSED:
                mLoading.setVisibility(View.GONE);
            ...
            case YHVideoPlayer.STATE_COMPLETED:
                ...
                break;
            case YHVideoPlayer.STATE_ERROR:
                cancelUpdateProgressTimer();
                setTopBottomVisible(false);
                mTop.setVisibility(View.VISIBLE);
    ...
    private void startUpdateProgressTimer()
    {
        ...
        if (mUpdateProgressTimerTask == null)
        {
            mUpdateProgressTimerTask = new TimerTask()
            {
                ...
                public void run()
                {
                    YHVideoPlayerController.this.post(new Runnable()
                    {
                        @Override
                        public void run()
                        {
    ...
    private void updateProgress()
    {
        ...
        mPosition.setText(StringUtils.formatTime(position));
