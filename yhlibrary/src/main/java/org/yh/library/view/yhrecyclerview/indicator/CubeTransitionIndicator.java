...
public class CubeTransitionIndicator extends BaseIndicatorController
{
    ...
    public List<Animator> createAnimation()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            ValueAnimator translationYAnim = ValueAnimator.ofFloat(startY, startY, getHeight() -
                    startY, getHeight() - startY, startY);
            if (i == 1)
            {
                translationYAnim = ValueAnimator.ofFloat(getHeight() - startY, getHeight() -
