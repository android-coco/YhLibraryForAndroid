...
public class JsInterfaceHolderImpl extends JsBaseInterfaceHolder {
    ...
    static JsInterfaceHolderImpl getJsInterfaceHolder(WebView webView, YHWebView.SecurityType securityType) {
    ...
    JsInterfaceHolderImpl(WebView webView, YHWebView.SecurityType securityType) {
        super(securityType);
