...
public abstract class JsBaseInterfaceHolder implements JsInterfaceHolder{
    ...
    protected JsBaseInterfaceHolder(YHWebView.SecurityType securityType){
    ...
    protected boolean checkSecurity(){
        return mSecurityType!= YHWebView.SecurityType.strict ?true:AgentWebConfig.WEBVIEW_TYPE==AgentWebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE?true:Build.VERSION.SDK_INT>Build.VERSION_CODES.JELLY_BEAN_MR1;
    }
