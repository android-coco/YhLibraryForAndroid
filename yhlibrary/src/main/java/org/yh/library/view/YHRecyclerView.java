...
import org.yh.library.view.yhrecyclerview.AppBarStateChangeListener;
import org.yh.library.view.yhrecyclerview.ArrowRefreshHeader;
import org.yh.library.view.yhrecyclerview.LoadingMoreFooter;
...
public class YHRecyclerView extends RecyclerView
{
    ...
    public YHRecyclerView(Context context)
    {
        this(context, null);
    }

    public YHRecyclerView(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public YHRecyclerView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        public void onChanged()
        {
            ...
            if (mWrapAdapter != null && mEmptyView != null)
            {
                ...
                } else
                {
                    ...
                    YHRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
